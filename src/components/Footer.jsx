            ...
            <div className="max-w-7xl mx-auto px-10 flex justify-between md:flex-row flex-col gap-9">
                <div className="max-w-[295px] w-full flex flex-col justify-between ">
                    <a className="flex" href="logo" >
                        <img className="md:w-[142px] md:h-[50px] w-[102.24px] h-9" src={logo} alt="logo" />
                    </a>
                    <p className="pt-[66px] text-[#64748B] font-medium md:font-semibold lg:font-bold md: text-sm md:text-base leading-6 md:leading-7">
